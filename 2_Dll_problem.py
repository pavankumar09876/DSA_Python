...
class dlinkedlist:
    ...
    def search(self,value):
        ...
        while temp:
            if temp.value == value:
                return f"{temp.value} is present"
            temp=temp.next
        return False
...
l=dlinkedlist()
for v in [2,1,1,2,3,3,3,3,4,5,5,6,7,7]:
    l.append(v)
# l2=dlinkedlist()
...
# l.split_list()
# l.traverse_backward()  
# print("remove odd:",l.remove_even())
# print("removed odd:",l.remove_odd())
# print("frequency:",l.frequency(3))
# print("search:",l.search(3))
print("Split_list_value:",l.split_list_value(6))
l.traverse_forward()